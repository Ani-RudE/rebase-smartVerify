...
const Sidebar = () => {
     return (
          <div className="z-10 bg-gray-800/[0.6] text-white w-64 space-y-6 py-16 px-3 absolute inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition duration-200 ease-in-out">
               <nav>
